...
@section('content')
    ...
    <div class="hero-wrap" style="background-image: url({{asset('images/yayasan6.jpeg')}});" data-stellar-background-ratio="0.5">
    ...
    @else
        <section class="ftco-section-3 img" style="background-image: url({{ asset('images/yayasan5.jpg') }});" id="donatur">
        <div class="overlay"></div>
        <div class="container">
            <div class="row d-md-flex">
                <div class="col-md-6 d-flex ftco-animate">
                    <div class="img img-2 align-self-stretch" style="background-image: url({{ asset('images/yayasan3.jpg') }});"></div>
                </div>
                <div class="col-md-6 volunteer pl-md-5 ftco-animate">
                    <h3 class="mb-3">Buat Akun Sebagai Donatur</h3>
                    <form action="{{ route('register') }}" method="post" class="volunter-form" onsubmit="return validateForm()">
                        @csrf
