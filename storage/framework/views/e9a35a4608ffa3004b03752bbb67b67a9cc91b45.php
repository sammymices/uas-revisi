            ...
            <div class="col-md-4 col-xl-4">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title mb-0"><?php echo e($profile ? $profile->name : 'Profile Tidak Ditemukan'); ?></h5>
                        <div class="text-muted mb-2"><?php echo e($profile ? $profile->email : 'Tidak ada email'); ?></div>
                    </div>
                    <hr class="my-0">
                    <div class="card-body">
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\abc_Gabrielipp\Semester3\projek_laravel\panti-asuhan\resources\views/dashboard/pages/profiles/index.blade.php ENDPATH**/ ?>